...
<div class="container-fluid py-5 d-flex justify-content-center">
    <div class="receipt border p-4 bg-white shadow" style="width: 450px; margin-top: 5rem">
        ...
        @if ($order->payment_method =='tunai')
            <p class="small text-center">Tunjukkan kode bayar ini ke kasir untuk menyelesaikan pembayaran. Terima Kasih!</p>
        @elseif ($order->payment_method == 'qris')
            <p class="small text-center">Pembayaran sukses. Duduk manis ya, pesanan kamu segera kami proses!</p>
        @endif
        <hr>
